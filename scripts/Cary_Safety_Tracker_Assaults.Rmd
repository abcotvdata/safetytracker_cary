...
The city averaged <h8>`r prettyNum(round(assaults_city$last12mos/12,0), big.mark=",")`</h8> aggravated assaults a month over the last 12 months. In 2019, that number was <h8>`r prettyNum(round(assaults_city$total19/12,0), big.mark=",")`</h8> a month.
...
<subhead>A closer look at Cary aggravated assaults neighborhood by neighborhood</subhead>

The danger is not the same neighborhood to neighborhood. ABC11's data team looked at the Cary Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
cary_assault_map <- leaflet(assaults_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
<br>
<br>
<iframe title="Aggravated assaults year by year in Cary" aria-label="Column Chart" id="datawrapper-chart-fzEtd" src="https://datawrapper.dwcdn.net/fzEtd/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<!-- <subhead>Risk of assault and other violent crimes in Oakland </subhead> -->
<br>
<br>
<iframe title="2021 violent crime rate comparison in select cities" aria-label="Bar Chart" id="datawrapper-chart-sTBZI" src="https://datawrapper.dwcdn.net/sTBZI/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="628" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
