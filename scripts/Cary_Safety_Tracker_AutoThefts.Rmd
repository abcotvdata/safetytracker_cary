...
The city averaged <h8>`r round(autothefts_city$last12mos/12,0)`</h8> stolen vehicles a month over the last 12 months. In 2019, that number was <h8>`r round(autothefts_city$total19/12,0)`</h8> a month.
...
<subhead>A closer look at Cary auto thefts by neighborhood</subhead>
...
cary_autotheft_map <- leaflet(autothefts_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
<br>
<br>
<iframe title="Vehicle thefts year by year in Cary" aria-label="Column Chart" id="datawrapper-chart-0rmVg" src="https://datawrapper.dwcdn.net/0rmVg/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
