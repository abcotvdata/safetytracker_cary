...
The city averaged <h8>`r round(burglaries_city$last12mos/12,0)`</h8> burglaries a month over the last 12 months. In 2019, that number was <h8>`r round(burglaries_city$total19/12,0)`</h8> a month.

<subhead>A closer look at Cary burglaries neighborhood by neighborhood</subhead>

The risk is not the same neighborhood to neighborhood. ABC11's data team looked at the Cary Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
burglarylabel <- paste(sep="",
                     ...
                     burglaries_district$district_name,
...
cary_burglary_map <- leaflet(burglaries_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
<br>
<br>
<iframe title="Burglaries year by year in Cary" aria-label="Column Chart" id="datawrapper-chart-tqi3G" src="https://datawrapper.dwcdn.net/tqi3G/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<!-- <subhead>Risk of property crime in major cities</subhead> -->
<br>
<br>
<iframe title="2021 property crime rate comparison in select cities" aria-label="Bar Chart" id="datawrapper-chart-YeKbj" src="https://datawrapper.dwcdn.net/YeKbj/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="628" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
