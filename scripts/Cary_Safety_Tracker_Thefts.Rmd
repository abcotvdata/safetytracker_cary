...
<div class="card" style="background-color:#99a0a5;">
<p>Average Thefts<br>2022 to 2024<br>
...
<div class="card" style="background-color:#99a0a5;">
<p>Average Theft Rate<br>2022 to 2024<br>
...
<subhead>Cary thefts neighborhood by neighborhood</subhead>
...
"</td>
				...
				<td>2023</td>
				<td>",
prettyNum(thefts_district$total23, big.mark=","),
"</td>
				<td>",
...
"</td>
				...
				<td>2024</td>
				<td>",
prettyNum(thefts_district$total24, big.mark=","),
"</td>
				<td>",
...
cary_theft_map <- leaflet(thefts_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
<br>
<br>
<iframe title="Thefts year by year in Cary" aria-label="Column Chart" id="datawrapper-chart-9iQKZ" src="https://datawrapper.dwcdn.net/9iQKZ/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
