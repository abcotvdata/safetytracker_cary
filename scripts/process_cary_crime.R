...
citywide_detailed$rate22 <- round(citywide_detailed$total22/cary_population*100000,1)
citywide_detailed$rate23 <- round(citywide_detailed$total23/cary_population*100000,1)
citywide_detailed$rate24 <- round(citywide_detailed$total24/cary_population*100000,1)
...
citywide_category$rate22 <- round(citywide_category$total22/cary_population*100000,1)
citywide_category$rate23 <- round(citywide_category$total23/cary_population*100000,1)
citywide_category$rate24 <- round(citywide_category$total24/cary_population*100000,1)
...
citywide_category_monthly %>% filter(category=="Larceny") %>% write_csv("data/output/monthly/thefts_monthly.csv")
...
citywide_category %>% select(1:9,11) %>% filter(category=="Murder") %>% write_csv("data/output/yearly/murders_city.csv")
# citywide_category %>% select(1,3:9,11) %>% filter(category=="Sexual Assault") %>%  write_csv("data/output/yearly/sexassaults_city.csv")
citywide_category %>% select(1:9,11) %>% filter(category=="Motor Vehicle Theft") %>%  write_csv("data/output/yearly/autothefts_city.csv")
citywide_category %>% select(1:9,11) %>% filter(category=="Larceny") %>%  write_csv("data/output/yearly/thefts_city.csv")
citywide_category %>% select(1:9,11) %>% filter(category=="Burglary") %>%  write_csv("data/output/yearly/burglaries_city.csv")
citywide_category %>% select(1:9,11) %>% filter(category=="Robbery") %>%  write_csv("data/output/yearly/robberies_city.csv")
citywide_category %>% select(1:9,11) %>% filter(category=="Aggravated Assault") %>%  write_csv("data/output/yearly/assaults_city.csv")
...
citywide_type$rate22 <- round(citywide_type$total22/cary_population*100000,1)
citywide_type$rate23 <- round(citywide_type$total23/cary_population*100000,1)
citywide_type$rate24 <- round(citywide_type$total24/cary_population*100000,1)
...
thefts_district <- district_category %>% filter(category=="Larceny")
...
thefts_city <- citywide_category %>% filter(category=="Larceny")
